...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'baserest' => 'getBaserestService',
            'cache_clearer' => 'getCacheClearerService',
            'cache_warmer' => 'getCacheWarmerService',
            'canvasbaserest' => 'getCanvasbaserestService',
            'controller_name_converter' => 'getControllerNameConverterService',
            'courserest' => 'getCourserestService',
            'curlhelper' => 'getCurlhelperService',
            ...
            'enrollmentrest' => 'getEnrollmentrestService',
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/song/projects/RenaissanceVideo/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/song/projects/RenaissanceVideo/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/home/song/projects/RenaissanceVideo/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/song/projects/RenaissanceVideo/app/Resources');

        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplatePathsCacheWarmer($c, $this->get('templating.locator')), 1 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetManagerCacheWarmer($this), 2 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router')), 3 => new \Symfony\Bundle\TwigBundle\CacheWarmer\TemplateCacheCacheWarmer($this, $c), 4 => new \Symfony\Bridge\Doctrine\CacheWarmer\ProxyCacheWarmer($this->get('doctrine'))));
    }

    /**
     * Gets the 'canvasbaserest' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Video\CommonBundle\REST\Canvas\CanvasBaseREST A Video\CommonBundle\REST\Canvas\CanvasBaseREST instance.
     */
    protected function getCanvasbaserestService()
    {
        return $this->services['canvasbaserest'] = new \Video\CommonBundle\REST\Canvas\CanvasBaseREST($this->get('curlhelper'), $this);
    }

    /**
     * Gets the 'courserest' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Video\CommonBundle\REST\Canvas\CourseREST A Video\CommonBundle\REST\Canvas\CourseREST instance.
     */
    protected function getCourserestService()
    {
        return $this->services['courserest'] = new \Video\CommonBundle\REST\Canvas\CourseREST($this->get('curlhelper'), $this);
    }

    /**
     * Gets the 'curlhelper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['curlhelper'] = new \Video\CommonBundle\Tools\CurlHelper('curlHelper.class.authed%');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'renaissancevideo', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_8f448a277ddbd83b9543a2eb036392851c6a2c434f2526bdadff474f357d6879');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_8f448a277ddbd83b9543a2eb036392851c6a2c434f2526bdadff474f357d6879');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_8f448a277ddbd83b9543a2eb036392851c6a2c434f2526bdadff474f357d6879');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/home/song/projects/RenaissanceVideo/src/Video/CommonBundle/Entity')), 'Video\\CommonBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('VideoCommonBundle' => 'Video\\CommonBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/home/song/projects/RenaissanceVideo/app/cache/dev/doctrine/orm/Proxies');
    ...
    /**
     * Gets the 'enrollmentrest' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Video\CommonBundle\REST\Canvas\EnrollmentREST A Video\CommonBundle\REST\Canvas\EnrollmentREST instance.
     */
    protected function getEnrollmentrestService()
    {
        return $this->services['enrollmentrest'] = new \Video\CommonBundle\REST\Canvas\EnrollmentREST($this->get('curlhelper'), $this);
    }
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/song/projects/RenaissanceVideo/app/Resources');
    }

    /**
     * Gets the 'filerest' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Video\CommonBundle\REST\Canvas\FileREST A Video\CommonBundle\REST\Canvas\FileREST instance.
     */
    protected function getFilerestService()
    {
        return $this->services['filerest'] = new \Video\CommonBundle\REST\Canvas\FileREST($this->get('curlhelper'), $this);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Video\CommonBundle\REST\Canvas\ModuleREST A Video\CommonBundle\REST\Canvas\ModuleREST instance.
     */
    protected function getModulerestService()
    {
        return $this->services['modulerest'] = new \Video\CommonBundle\REST\Canvas\ModuleREST($this->get('curlhelper'), $this);
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/song/projects/RenaissanceVideo/app/logs/dev.log', 100, true);
    }
    ...
    /**
     * Gets the 'pagerest' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Video\CommonBundle\REST\Canvas\PageREST A Video\CommonBundle\REST\Canvas\PageREST instance.
     */
    protected function getPagerestService()
    {
        return $this->services['pagerest'] = new \Video\CommonBundle\REST\Canvas\PageREST($this->get('curlhelper'), $this);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/song/projects/RenaissanceVideo/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/home/song/projects/RenaissanceVideo/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/home/song/projects/RenaissanceVideo/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/song/projects/RenaissanceVideo/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/home/song/projects/RenaissanceVideo/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/song/projects/RenaissanceVideo/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/song/projects/RenaissanceVideo/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/home/song/projects/RenaissanceVideo/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/song/projects/RenaissanceVideo/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/home/song/projects/RenaissanceVideo/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/song/projects/RenaissanceVideo/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/home/song/projects/RenaissanceVideo/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/home/song/projects/RenaissanceVideo/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/home/song/projects/RenaissanceVideo/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/home/song/projects/RenaissanceVideo/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/home/song/projects/RenaissanceVideo/vendor/nelmio/api-doc-bundle/Nelmio/ApiDocBundle/Resources/views', 'NelmioApiDoc');
        $instance->addPath('/home/song/projects/RenaissanceVideo/src/Video/WebBundle/Resources/views', 'VideoWeb');
        $instance->addPath('/home/song/projects/RenaissanceVideo/src/Video/CommonBundle/Resources/views', 'VideoCommon');
        $instance->addPath('/home/song/projects/RenaissanceVideo/src/Video/ApiBundle/Resources/views', 'VideoApi');
        $instance->addPath('/home/song/projects/RenaissanceVideo/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/home/song/projects/RenaissanceVideo/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/home/song/projects/RenaissanceVideo/app/Resources/views');
        $instance->addPath('/home/song/projects/RenaissanceVideo/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    /**
     * Gets the 'userrest' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Video\CommonBundle\REST\Canvas\UserREST A Video\CommonBundle\REST\Canvas\UserREST instance.
     */
    protected function getUserrestService()
    {
        return $this->services['userrest'] = new \Video\CommonBundle\REST\Canvas\UserREST($this->get('curlhelper'), $this);
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/home/song/projects/RenaissanceVideo/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/song/projects/RenaissanceVideo/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home/song/projects/RenaissanceVideo/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/song/projects/RenaissanceVideo/app/cache/dev');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'VideoWebBundle' => 'Video\\WebBundle\\VideoWebBundle',
                'VideoCommonBundle' => 'Video\\CommonBundle\\VideoCommonBundle',
                'VideoApiBundle' => 'Video\\ApiBundle\\VideoApiBundle',
            ...
            'database_port' => 3306,
            'database_name' => 'renaissancevideo',
            'database_user' => 'root',
            ...
            'video_external_url' => 'http://127.0.0.1:9000/show/',
            'canvas_api_url' => 'https://canvas.example.com/api/v1/',
            'canvas_api_token' => 'waMepYblCfAk16WeOoX7uBsjZNbjzhbdKZTZyMgpBaGbRxR9DiEAWoJb12LjT7i1',
            'canvas_api_auth_head' => 'Bearer',
            ...
            'debug.container.dump' => '/home/song/projects/RenaissanceVideo/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/home/song/projects/RenaissanceVideo/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/home/song/projects/RenaissanceVideo/app/cache/dev/profiler',
            ...
            'router.resource' => '/home/song/projects/RenaissanceVideo/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/song/projects/RenaissanceVideo/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/home/song/projects/RenaissanceVideo/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/song/projects/RenaissanceVideo/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/home/song/projects/RenaissanceVideo/app/../web',
            'assetic.write_to' => '/home/song/projects/RenaissanceVideo/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/home/song/projects/RenaissanceVideo/app/cache/dev/doctrine/orm/Proxies',
